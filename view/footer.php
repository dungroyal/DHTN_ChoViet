            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <div class="footer-address">
                                ...
                                <p>Di động: 0398022720 <br> Email - DHTNteam@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <div class="footer-widget">
                            <h5>Get Social</h5>
                            <p>Connected with our social media and<br> get update protidin</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <div class="copyright">
                            <p>2019 ® All Rights Reserved <span><a href="#">DHTN Team</a></span>.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <div class="payment text-right">
                            <img src="view/img/payment/1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- jquery
		============================================ -->
    <script src="view/js/vendor/jquery-1.12.3.min.js"></script>
    <!-- bootstrap JS
		============================================ -->
    ...
    <!-- price-slider JS
		============================================ -->
    <script src="view/js/jquery-price-slider.js"></script>
    <!-- Elevate Zoom js
		============================================ -->
    <script src="view/js/jquery.elevatezoom.js"></script>
    <!-- scrollUp JS
		============================================ -->
    ...
    <!-- Nevo Slider js
		============================================ -->
    <script type="text/javascript" src="view/lib/custom-slider/js/jquery.nivo.slider.js"></script>
    <script type="text/javascript" src="view/lib/custom-slider/home.js"></script>
    <!-- main JS
		============================================ -->
